...
| **20+ Languages** | TypeScript, JavaScript, Python, Go, Rust, Java, C#, PHP, Ruby, C, C++, Objective-C, Swift, Kotlin, Dart, Lua, Luau, Svelte, Liquid, Pascal/Delphi, SystemVerilog |
...
| SystemVerilog | `.sv`, `.svh`, `.v`, `.svi` | Full support (modules, interfaces, packages, classes, constraints, covergroups, typedefs, `rand` members, function/task extraction, call edges) |
